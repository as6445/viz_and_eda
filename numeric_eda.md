...
creating cold variable if max temp is less than 5C and not cold if its
more than that.
...
```
    ...
    ## # A tibble: 36 × 5
    ## # Groups:   name [3]
    ##    name           month      mean_tmax Na.rm median_tmax
    ##    <chr>          <date>         <dbl> <lgl>       <dbl>
    ##  1 CentralPark_NY 2017-01-01      5.98 TRUE          6.1
    ##  2 CentralPark_NY 2017-02-01      9.28 TRUE          8.3
    ##  3 CentralPark_NY 2017-03-01      8.22 TRUE          8.3
    ##  4 CentralPark_NY 2017-04-01     18.3  TRUE         18.3
    ##  5 CentralPark_NY 2017-05-01     20.1  TRUE         19.4
    ##  6 CentralPark_NY 2017-06-01     26.3  TRUE         27.2
    ##  7 CentralPark_NY 2017-07-01     28.7  TRUE         29.4
    ##  8 CentralPark_NY 2017-08-01     27.2  TRUE         27.2
    ##  9 CentralPark_NY 2017-09-01     25.4  TRUE         26.1
    ## 10 CentralPark_NY 2017-10-01     21.8  TRUE         22.2
    ## # … with 26 more rows
...
![](numeric_eda_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](numeric_eda_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
